...
- 半陰的Manning項はRK stage開始時流量を係数へ用いることで、正常水深`0.3944 m`の定常等流に対し水深・流量最大相対誤差`3.216e-8`となった。追加step更新を`dt`と基準量で割る時間残差は`1.56e-6/s`、`dt`半減時の差は`0.09%`である。
